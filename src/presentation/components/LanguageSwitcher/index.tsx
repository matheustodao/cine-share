...
export function LanguageSwitcher() {
  ...
  return (
    <Link href={`/${!supportedLanguages.includes(locale) ? 'pt-BR' : supportedLanguages[(supportedLanguages.indexOf(locale) + 1) >= 4 ? 0 : supportedLanguages.indexOf(locale) + 1]}${pathname}`} scroll={false}>
      <Image
